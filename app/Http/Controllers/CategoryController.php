...
class CategoryController extends Controller
{
    ...
    */
    ...
    /**
     * Restore data soft deleted category
     */
    ...
    public function deletePermanent($id)
    {
        ...
        /**
         * Make ajax endpoint for category
         * select2 akan mengambil data via ajax, sehingga kita perlu siapkan route untuk ajax ini
         */
